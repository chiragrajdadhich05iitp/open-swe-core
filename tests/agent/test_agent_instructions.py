...
@pytest.mark.asyncio
async def test_get_repo_agent_instructions_returns_trimmed_text(
...
@pytest.mark.asyncio
async def test_get_repo_agent_instructions_returns_none_when_empty(
    fake_store: FakeStore,
) -> None:
...
@pytest.mark.asyncio
async def test_list_agent_instructions_sorts_by_full_name(
    fake_store: FakeStore,
) -> None:
...
@pytest.mark.asyncio
async def test_delete_agent_instructions_requires_repo_access_before_delete(
    monkeypatch,
) -> None:
